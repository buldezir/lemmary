...
//
// router.ToApiError is exactly what ErrorHandler uses, so an error maps here
// the way it will map there -- including the errors that are not ApiErrors at
// all and become a 400 or a 500 on the way out.
